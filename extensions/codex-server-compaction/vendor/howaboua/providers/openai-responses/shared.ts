...
interface ConvertResponsesMessagesOptions {
	...
	grammarToolInputProperties?: ReadonlyMap<string, string> | undefined;
	/** Whether later system messages are sent in place instead of folded into the leading prompt. */
...
export function convertResponsesMessages<TApi extends Api>(
	...
	// Tools declared after the leading system message are anchored where they appear,
	// so a transport that supports it keeps the cached prompt/tool prefix intact.
